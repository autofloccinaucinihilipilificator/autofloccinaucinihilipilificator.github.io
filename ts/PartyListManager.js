...
class PartyListManager {
    ...
    addParty(title, subtitle, share, solidColor) {
        this.html.partyList.insertAdjacentHTML('beforeend', `<div id="party-${this.partyIDCounter}" class="party">
    ...
    checkTotalVoteShare() {
        let totalBasisPoints = 0; // avoid float problems
